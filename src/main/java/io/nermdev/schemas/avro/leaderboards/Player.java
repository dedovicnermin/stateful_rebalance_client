...
public class Player extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6081683972382298864L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Player\",\"namespace\":\"io.nermdev.schemas.avro.leaderboards\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   * @return A new Player RecordBuilder
   */
  public static Builder newBuilder(Player other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
